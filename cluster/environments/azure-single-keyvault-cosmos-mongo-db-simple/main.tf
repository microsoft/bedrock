...
module "aks-gitops" {
  source = "github.com/microsoft/bedrock?ref=0.11.1//cluster/azure/aks-gitops"
...
module "keyvault_flexvolume_role" {
  source = "github.com/microsoft/bedrock?ref=0.11.1//cluster/azure/keyvault_flexvol_role"
...
module "flex_volume" {
  source = "github.com/microsoft/bedrock?ref=0.11.1//cluster/azure/keyvault_flexvol"
