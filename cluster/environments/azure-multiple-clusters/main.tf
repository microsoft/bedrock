module "provider" {
  source = "github.com/microsoft/bedrock?ref=0.11.0//cluster/azure/provider"
}
...
module "keyvault_flexvolume_role" {
  source = "github.com/microsoft/bedrock?ref=0.11.0//cluster/azure/keyvault_flexvol_role"
