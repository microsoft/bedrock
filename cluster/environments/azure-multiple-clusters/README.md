...
* West Cluster
    ...
    - `git_west_path`: Path to a specific folder in the git repo
* Central cluster
    ...
    - `git_central_path`: Path to a specific folder in the git repo
* East Cluster
    ...
    - `git_east_path`: Path to a specific folder in the git repo
