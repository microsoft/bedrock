...
if [ -z $ACCOUNT ]; then
    az cosmosdb create --name $ACCOUNT_NAME --resource-group $RESOURCE_GROUP_NAME --default-consistency-level $CONSISTENCY --kind GlobalDocumentDB --locations "$Location=0"
