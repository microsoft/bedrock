...
# TeamCity needs basic reqs installed manually
...
function git_commit() {
    ...
    # Set git identity, and explicitly set env variables
    echo 'git config --global user.name "TeamCity"'
    echo 'git config --global user.email "teamcity@jetbrains.com"'
    git config --global user.name "TeamCity"
    git config --global user.email teamcity@jetbrains.com
    export GIT_AUTHOR_NAME="TeamCity"
    export GIT_COMMITTER_NAME="TeamCity"
    export EMAIL="teamcity@jetbrains.com"
